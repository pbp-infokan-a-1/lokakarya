...
urlpatterns = [
    ...
    path('products/<uuid:product_id>/update/', views.update_product_ajax, name='update_product_ajax'),
    path('products/<uuid:product_id>/delete/', views.delete_product_ajax, name='delete_product_ajax'),
